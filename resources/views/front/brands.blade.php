    ...
    <div>
      ...
      <div>
        @for($i=0;$i<count($brands);  $i++) 
          @if($i % 2 ==0)
            <div class="frist_brands">
              <div class="container row m-auto mt-5 pt-4 mb-5 pb-2">
                <div
                  class="col-lg-5 col-sm-12 col-xsm-12 col-12 m-auto hidddenright"
                  >
                  <div
                    style="
                      display: flex;
                  ...
                  >
                    ...
                    <img
                      id="left_chess"
                      src="/images/group-39483leftches.png"
                      alt=""
                    />
                  </div>
                  <img
                    style="position: absolute; transform: translate(-70%, -40%)"
                    src="/images/cheese-1rightchess.png"
                    alt=""
                  />
                  <div id="img_adding">
                    <img
                      id="cheese_img"
                      src="/images/containehiui7r.png"
                      alt=""
                    />
                    <div id="img_who">
                      <img style="    height: 100%;width: 85%;" src="/{{$brands[$i]->logo}}" alt="" />
                    </div>
                  </div>
                </div>
                <div
                  class="col-lg-6 col-sm-12 col-xsm-12 col-12 m-auto hidddenleft"
                  >
                  <div
                    style="
                      display: flex;
                  ...
                  >
                Read More
                  <img src="/images/vectorrerer3444.svg" alt="" />
                </button>
                </a>
                  </div>
                </div>
          ...
          @else
            <div class="frist_brands">
              <h1 id="syrian_head"> {{$brands[$i]->text1}}</h1>
              <div class="container row m-auto mt-5 pt-4 mb-5 pb-2">
                <div
                  id="top_tex"
                  class="col-lg-6 col-sm-12 col-xsm-12 col-12 m-auto hidddenright"
                >
                  <p
                    id="tex_chee"
                    style="
                ...
                >
                  Read More
                  <img src="/images/vectorgreen.svg" alt="" />
                </button>
                </a>
                </div>
                <div
                  class="col-lg-5 col-sm-12 col-xsm-12 col-12 m-auto hidddenleft"
                >
                  <img
                    style="position: absolute; transform: translate(-70%, 5%)"
                    src="/images/olives7777.png"
                    alt=""
                  />
                  <img
                    id="ovil_oil"
                    ...
                    "
                    src="/images/olive-oil8888.png"
                    alt=""
                  />
                  <div id="img_adding2">
                    <img
                      id="cheese_img"
                      src="/images/containersyrian.png"
                      alt=""
                    />
                    <div id="img_who2">
                      <img src="/{{$brands[$i]->logo}}" alt="" />
                    </div>
                  </div>
                </div>
                ...
                <div
                  id="button_tex"
                  style="display: none"
                  class="mt-3 col-lg-6 col-sm-12 col-xsm-12 col-12 m-auto hidddenleft"
                >
                  <p
                    id="tex_chee"
                    style="
