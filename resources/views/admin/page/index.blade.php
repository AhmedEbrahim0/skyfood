		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
                ...
                <div class="bg-white p-2">
					...
					<form method="post" action="/admin/update-page" enctype="multipart/form-data" enctype="multipart/form-data">
						@csrf
						...
						<div>
							<img id="output_image" style="height: 200px; width:200px" src="/{{$page1->image}}" alt="">
						</div>
