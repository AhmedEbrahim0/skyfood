		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0"> Add Innvation</h2>
				</div>
				...
				<div class="bg-white p-2">
                    ...
                    <form action="/admin/store-innvation" enctype="multipart/form-data" method="post">
                        @csrf

                        <div style="display: flex; align-items:flex-start;" class="my-2">
                            <textarea class="textarea mx-2" name="text1" style="width: 70%; height:200px" placeholder="Title "></textarea>
                            <div>
                                <label style="display: block;" for="image" class="btn btn-primary"> Upload Side Image </label>
                        ...
                        <div>
                            <div style="display: flex; align-items:flex-start;" class="my-2">
                                <textarea class="textarea mx-2" name="text2" style="width: 70%; height:200px" placeholder="Card Description "></textarea>
                            <div>
                                <label style="display: block;" for="card" class="btn btn-primary"> Upload Card Image </label>
