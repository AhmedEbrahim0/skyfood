                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach($page1 as $data)
                                    <tr>
                                        <td>{{$data->text1}}</td>
                                        <td><img src="/{{$data->logo}}"  style="height:100px;width:100px" alt=""></td>
                                        <td>
                                            <a href="/admin/edit-brands/{{$data->id}}" class="btn btn-primary"> Edit </a>
                                        </td>
                                        <td>
                                            <form action="/admin/delete-brands" method="post">
                                                @csrf
