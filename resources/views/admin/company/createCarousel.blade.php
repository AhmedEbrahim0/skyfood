		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0"> Add Slider</h2>
				</div>
				...
				<div class="bg-white p-2">
                    ...
                    <form action="/admin/store-carousel-company" enctype="multipart/form-data" method="post">
                        @csrf

                        <div>
                            <textarea class="textarea" name="text1" placeholder="Description "></textarea>
                        </div>
