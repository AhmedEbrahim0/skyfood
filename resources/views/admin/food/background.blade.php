		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0"> Background of Food</h2>
				</div>
                ...
                <div class="bg-white p-2">
					...
					<form method="post"  enctype="multipart/form-data" enctype="multipart/form-data">
						...
						<div>
						@if(pathinfo($data->image, PATHINFO_EXTENSION) == "jpg" ||pathinfo($data->image, PATHINFO_EXTENSION) == "png"  )
							<img id="output_image1" style="height: 200px; width:200px" src="/{{$data->image}}" alt="">
							@else
							<video muted loop autoplay  id="output_image2"  style="height: 200px; width:200px" src="/{{$data->image}}"  ></video>
							@endif
						</div>

						<div>
							<textarea  class="textarea" name="text1"  rows="10">{{$data->text1}}</textarea>
						</div>
						<div>
