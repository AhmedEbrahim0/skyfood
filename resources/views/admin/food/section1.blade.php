		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0"> Stringent Quality Control </h2>
				</div>
                ...
                <div class="bg-white p-2">
					...
					<form method="post" action="/admin/update-food-section1" enctype="multipart/form-data" enctype="multipart/form-data">
						@csrf
